    ...
    return (
      <div className={drawerClasses}>
        ...
        <div className="row-eq-height row">
          <div className="col-sm-12 col-md-4">
            <div className="gradient-blackberry card">
              <div className="px-3 py-3 card-body">
                <div className="media">
                  <div className="white media-body">
                    <h3 className="mb-1">{this.props.caseconfirmed}</h3>
          ...
          <div className="col-sm-12 col-md-4">
            <div className="gradient-ibiza-sunset card">
              <div className="px-3 py-3 card-body">
                <div className="media">
                  <div className="white media-body">
                    <h3 className="mb-1">{data.deaths}</h3>
          ...
          <div className="col-sm-12 col-md-4">
            <div className="gradient-green-teal card">
              <div className="px-3 py-3 card-body">
                <div className="media">
                  <div className="white media-body">
                    <h3 className="mb-1">{data.recovered}</h3>
