            ...
            <div class="gradient-blackberry card">
              <div class="px-3 py-3 card-body">
                <div class="media">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="gradient-ibiza-sunset card">
              <div class="px-3 py-3 card-body">
                <div class="media">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg"viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }} width="56px" height="56px" fill="#ffffff" stroke="#ffffff" stroke-width="8">
